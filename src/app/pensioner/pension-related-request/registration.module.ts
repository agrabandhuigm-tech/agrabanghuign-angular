...
import { PensionerPaySlipComponent } from '../selfservice/pensionselfservice/pensioner-pay-slip/pensioner-pay-slip.component';
import { PensionerFinancialYearStatusComponent } from '../selfservice/pensionselfservice/pensioner-financial-year-status/pensioner-financial-year-status.component';
import { NotionalIncrementComponent } from './notional-increment/notional-increment.component';
import { PensionStatementComponent } from '../selfservice/pensionselfservice/pension-statement/pension-statement.component';
...
},
{
  ...
  {
    path: 'payslip',
    component: PensionerPaySlipComponent,
    data: { page_id: 9 }
  },
  {
    path: 'pensionerStatement',
    component: PensionStatementComponent,
    data: { page_id: 10 }
  },
  {
    path: 'finacialyearstatus',
    component: PensionerFinancialYearStatusComponent,
  },
  {path: 'notional-increment', component: NotionalIncrementComponent},
  {
    path:'pp',component:PayEntitlementComponent
  }
...
@NgModule({
  declarations: [
    ...
    PensionerPaySlipComponent,
    PensionerFinancialYearStatusComponent,
    NotionalIncrementComponent,
