...
export class PreviewPensionEssComponent implements OnInit {
 ...
 PdocumentList:any;
  constructor(   @Inject(MAT_DIALOG_DATA) public data: {message: any,empData:any},public apiService:ApiEssService,public api:ApiService,private dialogRef: MatDialogRef<PreviewPensionEssComponent>,public date:DatePipe) { }
